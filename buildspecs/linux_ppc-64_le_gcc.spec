...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_ppc-64_le_gcc">
	<name>Linux PPC LE 64bit GCC</name>
	...
	<properties>
		...
		<property name="graph_enable_gcc7_cmd" value="source {$buildinfo.fsroot.unixBin$}/platform/linuxppcle/set_gcc7_env &amp;&amp;"/>
		<property name="graph_label.classlib" value="150"/>
		<property name="graph_label.java5" value="j9vmxp64le24_gcc"/>
		<property name="graph_label.java6" value="pxp64le60_gcc"/>
		<property name="graph_label.java60_26" value="pxp64le60_26_gcc"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pxp64le70_gcc"/>
		<property name="graph_label.java70_27" value="pxp64le70_27_gcc"/>
		<property name="graph_label.java8" value="pxp64le80_gcc"/>
		<property name="graph_label.java9" value="pxp64le90_gcc"/>
		<property name="graph_label.osid" value="lnx"/>
		<property name="graph_label.profile" value="_le_gcc"/>
