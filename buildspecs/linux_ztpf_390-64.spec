...
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_ztpf_390-64">
	<name>ZTPF S390 64bit Builder</name>
	...
	<properties>
		...
		<property name="SE6_package" value="tz64"/>
		<property name="canTestLocally" value="false"/>
		<property name="complianceTestingJavaLibraryPath" value="linux_ztpf_390-64"/>
		<property name="crossCompilerPath" value="/opt/gcc/current46/bin:/ztpf/commit/linux/bin"/>
		...
		<property name="graph_label.java6" value="ptz6460"/>
		<property name="graph_label.java60_26" value="ptz6460_26"/>
		<property name="graph_label.java7" value="ptz6470"/>
		<property name="graph_label.java70_27" value="ptz6470_27"/>
		<property name="graph_label.java8" value="ptz6480"/>
		<property name="graph_label.java9" value="ptz6490"/>
		...
		<property name="j2seTags" value="ptz6460,j9vmtz6424"/>
		...
		<property name="javatestPlatform" value="linux_ztpf_390-64"/>
		...
		<property name="main_shortname" value="tz64"/>
		...
		<property name="uma_make_cmd_cpp" value="tpf-cpp -E -P"/>
		<property name="uma_make_cmd_cxx" value="tpf-g++"/>
		...
		<property name="uma_make_cmd_ranlib" value="tpf-ranlib"/>
		<property name="uma_processor" value="s390"/>
		<property name="uma_type" value="unix,linux,ztpf"/>
	</properties>
	<features>
		<feature id="combogc"/>
		<feature id="core"/>
	...
	<flags>
		...
		<flag id="graph_smalltalkArtifacts" value="true"/>
