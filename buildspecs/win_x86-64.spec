...
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="win_x86-64">
	...
	<owners>
		<owner>patrick_dubroy@ca.ibm.com</owner>
	</owners>
	<properties>
		...
		<property name="graph_label.java60_26" value="pwa6460_26"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pwa6470"/>
		<property name="graph_label.java70_27" value="pwa6470_27"/>
		<property name="graph_label.java7_raw" value="jdk7-windows-x64"/>
		<property name="graph_label.java8" value="pwa6480"/>
		<property name="graph_label.java8_raw" value="jdk8-windows-x64"/>
		<property name="graph_label.java9" value="pwa6490"/>
		...
		<property name="graph_tool_script.build" value="msvc100_amd64"/>
		...
		<property name="j2seTags" value="pwa6460,j9vmwa6424"/>
		<property name="j9BuildName" value="win_x86-64"/>
		...
		<property name="javatestPlatform" value="win_x86-64"/>
		...
		<property name="sun.jdk7.platform_id" value="windows-x64"/>
		<property name="sun.jdk8.platform_id" value="windows-x64"/>
