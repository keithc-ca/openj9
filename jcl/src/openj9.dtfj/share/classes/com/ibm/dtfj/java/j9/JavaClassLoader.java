...
public class JavaClassLoader implements com.ibm.dtfj.java.JavaClassLoader
{
	...
	private List<Long> _classIDs = new ArrayList<>();
	private JavaObject _object = null;
	private List<JavaClass> _defined = null;
	private List<Object> _cached = null;
	...
	{
		for (Iterator<?> classes = getDefinedClasses(); classes.hasNext();) {
			Object next = classes.next();
			if (next instanceof JavaClass) {
				JavaClass one = (JavaClass) next;
