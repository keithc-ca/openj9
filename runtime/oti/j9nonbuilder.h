...
#if defined(J9VM_OPT_VALHALLA_FLATTENABLE_VALUE_TYPES)
/* Layout field occupies 3 bits in MemberName.flags. */
#define MN_LAYOUT_SHIFT 28
#define MN_LAYOUT_MASK (0x70000000 >> MN_LAYOUT_SHIFT)
#define MN_FLAT_FIELD (1 << MN_LAYOUT_SHIFT)
#endif /* defined(J9VM_OPT_VALHALLA_FLATTENABLE_VALUE_TYPES) */
...
typedef struct J9InternalVMFunctions {
	...
	struct J9Class *(*segmentIteratorNextClass)(struct J9Class **nextClass);
